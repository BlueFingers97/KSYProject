...
public class PreFlightCorsConfiguration {
    ...
    // private static final String ALLOWED_ORIGIN = "http://localhost:11000, http://localhost:19000, http://localhost:16000";

    private static final List<String> ALLOWED_ORIGINS = Arrays.asList("http://localhost:16000", "http://localhost:19000", "http://localhost:11000", "http://localhost:15000", "http://localhost:13000");
    ...
    public WebFilter corsFilter() {
        ...
        return (ServerWebExchange ctx, WebFilterChain chain) -> {
            ...
            if (CorsUtils.isPreFlightRequest(request)) {
                ...
                // 요청한 원본에 따라 동적으로 허용하는 원본을 설정
                // headers.add("Access-Control-Allow-Origin", request.getHeaders().getOrigin());  이렇게 하면 "*"랑 뭐가 달라 위험하잖아
                // 요청한 Origin이 허용 목록에 있는지 확인하여 설정
